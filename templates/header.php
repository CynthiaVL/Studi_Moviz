...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <img src="<?= ASSETS_IMAGES_FOLDER.'logo-moviz.png'?>" width="100">
            <ul class="nav nav-pills">
                <li class="nav-item d-flex align-items-center justify-content-center">
                    <a href="/" class="nav-link px-4 <?= NavigationTools::addActiveClass('page', 'home') ?>">Accueil</a>
                    <a href="/index.php?controller=movie&action=list" class="nav-link px-4 <?= NavigationTools::addActiveClass('movie', 'list') ?>">Tous les films</a>
                </li>
            </ul>
